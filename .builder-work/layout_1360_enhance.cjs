...
b.patch("Window/Text_WinTitle", Object.assign({ pos:[-540,395], rect_size:[260,40] }, MC));
b.patch("Window/Btn_CloseMain", Object.assign({ pos:[625,395], rect_size:[48,48] }, MC));

// ── 좌열 270×750 (착용 4 + 잠금 3만) ──
...
b.patch("Panel_EquipList/Text_Title", Object.assign({ pos:[0,338], rect_size:[250,32] }, MC));
const EC=[["EquipCell_1",-48,250],["EquipCell_2",48,250],["EquipCell_3",-48,158],["EquipCell_4",48,158]];
for (const [nm,x,y] of EC) b.patch("Panel_EquipList/"+nm, Object.assign({ pos:[x,y], rect_size:[88,88] }, MC));
const LK=[[-88,62],[0,62],[88,62]];
...
b.patch("Panel_EquipList/Text_Section", Object.assign({ pos:[0,-18], rect_size:[250,24] }, MC));
b.patch("Panel_EquipList/Grid", Object.assign({ pos:[0,-192], rect_size:[240,340] }, MC));
...
b.upsertComponent(S+"/Layout_Prob","MOD.Core.ScrollLayoutGroupComponent",{ "@type":"MOD.Core.ScrollLayoutGroupComponent", Type:0, CellSize:{x:210,y:120}, Spacing:16, ChildAlignment:4, UseScroll:false, Enable:true });
b.patch(S+"/Layout_Prob", Object.assign({ pos:[0,-238], rect_size:[690,130] }, TC));
for (const col of ["Success","Keep","Destroy"]) {
  b.patch(S+"/Layout_Prob/"+col, Object.assign({ pos:[0,0], rect_size:[210,120] }, MC));
  b.patch(S+"/Layout_Prob/"+col+"/PrecentTitle", Object.assign({ pos:[0,36], rect_size:[190,28] }, MC));
  b.patch(S+"/Layout_Prob/"+col+"/PercentBG", Object.assign({ pos:[0,-22], rect_size:[190,60] }, MC));
}
...
console.log("enhance 1360x860 (3 locks) done");
